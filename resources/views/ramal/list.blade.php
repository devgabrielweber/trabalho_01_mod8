...
@section('titulo', 'Listagem de Ramais')

@section('content')

    <h3 class="pt-4 text-4xl font-medium text-center mb-4">Listagem de Ramais</h3>
    <div
        ...
        <form action="{{ route('ramal.search') }}" method="post">
            @csrf
                            ...
                            @foreach ($ramals as $item)
                                <tr
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4"><a
                                            href="{{ route('ramal.edit', $item->id) }}"><i class="fa-solid fa-pen-to-square"
                                                style="color: blue;"></i></a></td>
                                    <td class="whitespace-nowrap px-6 py-4"><a href="{{ route('ramal-delete', $item->id) }}"
